function [ Rad ] = processTraceRemoval( Rad, f0, dt, offset )
...
isCleanNaN = 1;      % Control Flag for NaN Clean-up of Data
isStak = 1;          % Control Flag to Stack Data
    ...
    if isBandPass
        ...
        % Function
        Rad = bpfilter( Rad, dtSec, fMin, fMax, 2 );
